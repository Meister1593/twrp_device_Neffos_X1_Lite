...
LOCAL_PATH := device/Neffos/X1_Lite
...
### Partitions
# Partitions (size in bytes, /1024 for size on device)
BOARD_BOOTIMAGE_PARTITION_SIZE := 0x1000000 # 16MB
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 0x1000000 # 16MB
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 0xDD800000 # 3716MB
BOARD_CACHEIMAGE_PARTITION_SIZE := 0x1B000000 # 452MB
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x29C5FBC00 # 11213MB
...
TW_DEVICE_VERSION := plyshka@0621.discord
